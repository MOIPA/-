...
//搜索返回给指针
$sql_back = "select count(follower.aid) as followers,ruserorderinfo3.* from ruserorderinfo3,orderstatus,follower where ruserorderinfo3.com=$com and orderstatus!='待审核' and ruserorderinfo3.orderid=follower.orderid and ruserorderinfo3.orderid=orderstatus.orderid group by ruserorderinfo3.orderid";

$sql_back2 = "select count(follower.aid) as followers,ruserorderinfo3.*,orderstatus.* from ruserorderinfo3,orderstatus,follower where ruserorderinfo3.com=$com and orderstatus.orderstatus!='待审核' and ruserorderinfo3.orderid=follower.orderid and ruserorderinfo3.orderid=orderstatus.orderid group by ruserorderinfo3.orderid,orderstatus.orderstatus,orderstatus.peoplelimit,orderstatus.currentpeople";
...
where main.com=$com and orderstatus.orderstatus!='待审核' and orderstatus.orderid = main.orderid 
