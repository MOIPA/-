<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calculator.aspx.cs" Inherits="sy2_4_Calculator" %>
...
<body>
    ...
    <div style="text-align:center;">
        ...
        简易计算器<br/><asp:TextBox ID="txtDisplay" runat="server" OnTextChanged="TextBox1_TextChanged" ReadOnly="True" Width="110px"></asp:TextBox>
       <br/>
